  ...
  return (
    <div>
        ...
        <header id="header" className='fix-top'>
            {/*header*/}
            <div className="header_top fix_top">
            {/*header_top*/}
            ...
            <div className="container">
                ...
                <div className="col-md-8 clearfix">
                    ...
                    <ul className="nav navbar-nav">
                        <li>
                        <Link to='/account/update'><i className="fa fa-user" /> Account</Link>
                        </li>
                        <li>
                        <a href="">
                        ...
                        <Link to="/cart">
                            <i className="fa fa-shopping-cart" /> Cart {qtyCart}
                        </Link>
                        </li>
                       
                        {
                            getLogin ? 
                            <li><Link onClick={renderLogin} to="/login"><i className="fa fa-lock" /> Logout</Link></li> 
                            :
                            <li><Link to="/register"><i className="fa fa-lock" /> Login</Link></li>
                        }
